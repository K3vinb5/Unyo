...
import 'package:unyo/widgets/anime/anime_widget.dart';
import 'package:unyo/widgets/styled/styled_textfield.dart';
import 'package:unyo/widgets/styled/window_buttons.dart';

import '../widgets/styled/styled_dropdown.dart';
              ...
              Row(
                ...
                children: [
                  ...
                  StyledDropDown(
                    ...
                    items: format.map((e) => Text(e)).toList(),
                  ),
                  ...[
                    StyledDropDown(
                      horizontalPadding: 8,
                    ...
                    StyledDropDown(
                      ...
                      items: status.map((e) => Text(e)).toList(),
                    ),
                  ],
                  StyledDropDown(
                    horizontalPadding: 8,
                  ...
                  children: [
                    Wrap(
                      ...
                      children: searchMediaList.mapIndexed((index, mediaModel) {
                        ...
                        final widgetWidth =
                            min(max(w, minimumWidth), maximumWidth);
                        final widgetHeight =
                            min(max(h, minimumHeight), maximumHeight);
                        final mediaTile = AnimeWidget(
